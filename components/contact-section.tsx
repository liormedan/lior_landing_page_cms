            ...
            <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr]">
              ...
              <div className="space-y-6 text-right">
                ...
                <p className="text-base leading-relaxed text-slate-200">
                  השיחה נמשכת כ‑30 דקות. נבין את היעדים, נבדוק אילו תכנים קיימים, אילו חיבורים נדרשים ונראה אם אנחנו הצוות הנכון למשימה.
                </p>
                ...
                <ul className="space-y-3 text-sm leading-relaxed text-slate-200" role="list">
                  <li className="flex items-start gap-2 justify-start" role="listitem">
                    ...
                    <span>תיאום ציפיות קצר: מטרות, קהל יעד, טכנולוגיות ומגבלות.</span>
                  </li>
                  <li className="flex items-start gap-2 justify-start" role="listitem">
                    <span className="mt-1 inline-block h-2.5 w-2.5 rounded-full bg-blue-700/70" aria-hidden="true" />
                    <span>מסגרת תכולה ראשונית + אסטרטגיית פיתוח (Sanity/Next.js/SEO/נגישות).</span>
                  </li>
                  <li className="flex items-start gap-2 justify-start" role="listitem">
                    <span className="mt-1 inline-block h-2.5 w-2.5 rounded-full bg-blue-700/70" aria-hidden="true" />
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
                ...
                <p className="mt-2 text-center text-slate-200">
                  השיחה הראשונה נמשכת כ‑30 דקות. נבין את היעדים, נבדוק אילו תכנים קיימים, אילו חיבורים נדרשים ונראה אם אנחנו הצוות הנכון למשימה.
                  לאחר מכן נקבל מכם חומרי רקע לבניית הצעה מפורטת.
                </p>
