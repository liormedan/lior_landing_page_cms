...
export const landingPageContent = {
  hero: {
    ...
    lines: [
      'עדכוני תוכן קלים ומהירים ללא קוד, מותאם לעברית (RTL) וביצועים גבוהים.',
      'מבני תוכן מודולריים, קומפוננטות ניתנות לשילוב ושינוי זריז לפי הצורך.',
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          'אינטגרציות שיווק (לדוגמה: CRM/טפסים/Analytics)',
        ],
